...
router
  .route('/')
  .post(auth('manageUsers'), validate(paymentValidation.createPayment), paymentController.createPayment)
  .get(auth('getUsers'), validate(paymentValidation.getPayments), paymentController.getPayments);

router
  .route('/:paymentId')
  .get(auth('getUsers'), validate(paymentValidation.getPayment), paymentController.getPayment)
  .patch(auth('manageUsers'), validate(paymentValidation.updatePayment), paymentController.updatePayment)
  .delete(auth('manageUsers'), validate(paymentValidation.deletePayment), paymentController.deletePayment);
