...
router
  .route('/')
  .post(auth('manageUsers'), validate(teacherValidation.createTeacher), teacherController.createTeacher)
  .get(auth('getUsers'), validate(teacherValidation.getTeachers), teacherController.getTeachers);

router
  .route('/:id')
  .get(auth('getUsers'), validate(teacherValidation.getTeacher), teacherController.getTeacher)
  .patch(auth('manageUsers'), validate(teacherValidation.updateTeacher), teacherController.updateTeacher)
  .delete(auth('manageUsers'), validate(teacherValidation.deleteTeacher), teacherController.deleteTeacher);
