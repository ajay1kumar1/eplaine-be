...
router
  ...
  .get(auth('getUsers'), validate(subjectValidation.getSubjects), subjectController.getSubjects);

router
  .route('/:subjectId')
  .get(auth('getUsers'), validate(subjectValidation.getSubject), subjectController.getSubject)
 ...
 *     description: Only admins can create other subjects.
 *     tags: [Subjects]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
